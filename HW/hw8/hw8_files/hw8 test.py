...
while step < 100: 
    ...
    for n in range(len(players)):            
        #if the individual is at the edge of the broad, he or she will stop
        if ((players[n].x+players[n].dx) >= 1000\
           ...
           and players[n].name not in stop:                      
            ...
            #print(players[n].name+' stopped at simulation step '+str(step+1)+' at location ({:.1f}'.format(players[n].x)+',{:.1f}'.format(players[n].y)+')')
            #print()
